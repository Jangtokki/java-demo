package java_018_collection.prob;
import java.io.File;
...
public class Prob002_LinkedList {
	...
	public static void main(String[] args) {
		...
		// 수행하는 프로그램을 구현하시오.
		try {
			Scanner sc = new Scanner(new File(".\\src\\java_018_collection\\prob\\hospital.txt"));
			while(sc.hasNextLine()) {
				String []data = sc.nextLine().split("/");
		
				Doctor dt = new Doctor(data[0], data[1], Integer.parseInt(data[2]));
				queue.offer(dt);
