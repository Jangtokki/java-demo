...
public class java_157_exception {
	...
	/* sc.nextInt()메소드는 정수를 입력하면 게행문자 앞까지만 읽어오지만
	 * 에러가 발생하여 게행문자가 버퍼에 남아있어
	 * 다시 정수입력하때 개행문자가 자동으로 입력되기 때문에 무한반복이 일어난다.
	 * \r : carriage return 게행문자(13)
	 * \n : new line 줄바꿈(10)
	 * 
	 * 
	 */
