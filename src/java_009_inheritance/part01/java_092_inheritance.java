package java_009_inheritance.part01;


/*
 * 상속(inheritance) : 기본 클래스가 가지고 있는 멤버들을 새로 만들 클래스에서 직접 만들지 않고
 * 					상속을 받음으로써 새 클리스가 자신의 멤버처럼 사용할 수 있게 만들 기술이다.
 * 
 * 상속(inheritance)
 ...
 * 4. 자식(손)은 조상의 모든 자원을 상속받는다. (생성자, static{}은 제외)
 * 5. 자식의 자원은 부모보다 크거나 같아야 한다.
 * 6. 상속을 할때 사용되는 키워드 : extends
 * 		클래스의 클래스를 상속 : 단일상속, 인터페이스에 인터페이스 상속 : 다중 상속
 * 
 * 		class A { }
 * 		class B extends A { }
 ...
 * 
 * 		A는 B에게 상속한다.
 * 		B 는 A 이다. (상속관계의 클래스를 is a 관계라 한다)
 * 
 * 		class 도형 { }
 * 		class 삼각형 extends 도형{}
 * 
 */
public class java_092_inheritance {
	...
	public static void main(String[] args) {
		...
		//c멤버 변ㄴ수는 private으로 선언되어 있기때문에 상속이 안된다.
